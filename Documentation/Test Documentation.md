Я имел виду если генерировать схему подсистема → компонент → модуль → файл → функция, то какой насколько объёмным он будет ? Сколько можно сгенерировать подсистем, компонентов, модулей, файлов, функций ?
